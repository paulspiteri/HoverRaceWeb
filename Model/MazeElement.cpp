...
BOOL MR_Element::InitString( const char* pInitStr )
{
   ...
   // Return an error if this functio have not been 
   // overrided and if the parameters are not null

   if( pInitStr != NULL )
   {
      if( strlen( pInitStr ) > 0 )
      {
         lReturnValue = FALSE;
      }
   }
...
void MR_Element::ApplyEffect( const MR_ContactEffect* /*pEffect*/,  MR_SimulationTime /*pTime*/,MR_SimulationTime /*pDuration*/, BOOL /*pValidRirection*/, MR_Angle /*pHorizontalDirection*/, MR_Int32 /*pZMin*/, MR_Int32 /*pZMax*/, MR_Level* /*pLevel*/ )
{
...
void MR_SurfaceElement::RenderWallSurface(  MR_3DViewPort* /*pDest*/, const MR_3DCoordinate& /*pUpperLeft*/, const MR_3DCoordinate& /*pLowerRight*/, MR_Int32 /*pLen*/, MR_SimulationTime /*pTime*/ )
{
   // Notting is rendered by default
}

void MR_SurfaceElement::RenderHorizontalSurface( MR_3DViewPort* /*pDest*/, int /*pNbVertex*/, const MR_2DCoordinate* /*pVertexList*/, MR_Int32 /*pLevel*/, BOOL /*pTop*/, MR_SimulationTime /*pTime*/ )
{
   // Notting is rendered by default
}
